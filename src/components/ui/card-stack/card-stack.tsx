    ...
    <div className="relative h-60 w-60 md:h-60 md:w-96">
      {cards.map((card, index) => {
        return (
          <motion.div
            key={card.id}
            className="absolute h-60 w-60 md:h-60 md:w-96 rounded-3xl p-4 shadow-xl border border-y-3 border-solid border-slate-800 border-x-0 dark:border-white/[0.1] shadow-black/[0.1] dark:shadow-white/[0.05] flex flex-col justify-between"
            style={{
          ...
          >
            ...
            <div className="relative z-10">
              <div className=" text-white font-extralight dark:text-neutral-200">
                {card.content}
              </div>
              <div>
                <a href={card.href}>
