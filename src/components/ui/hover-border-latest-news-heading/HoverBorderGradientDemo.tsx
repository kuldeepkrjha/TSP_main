  ...
  return (
    <div className="flex justify-center text-center items-center p-10">
      ...
      >
        ...
        <span className="relative justify-center flex pb-2 px-[110px] bg-gradient-to-r items-center from-blue-500  via-rose-500 to-cyan-600 bg-clip-text text-3xl font-extrabold text-transparent text-center select-auto shadow-sm">{topic}</span>
      </HoverBorderGradient>
    </div>
  );
}
