...
const Navbar = ({ setShowLogin, setShowRegister }) => {
  return (
    <header className="navbar">
      <div className="logo">
        <img src={logo} alt="Government of Chhattisgarh" className="h-14 w-15"/>
      </div>
      <h1 className="relative flex items-center justify-between sm:px-2 lg:px-1">Government of Chhattisgarh</h1>
      {/* <nav>
