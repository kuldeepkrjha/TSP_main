...
const FinancialLiteracy = () => {
  return (
    ...
    <div className=' items-start flex flex-col text-center mr-10'>
    ...
    <h2 link='https://old.ncfe.org.in/program/fetp' className={cn("md:text-6xl sm:3xl text-2xl text-white relative font-black mb-5 z-20")}>Financial Literacy</h2> </a>
        <p className='text-center mt-2 text-neutral-300 relative z-20 text-sm flex flex-col text-balance font-bold'>Improve your financial literacy with our resources and training programs.</p>
    </div>
    <div className=' z-20 items-start mt-28 '>
